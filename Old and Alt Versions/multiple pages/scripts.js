...
function switchToVerticalScreen() {
    ...
    if (portraitContainer != null) { 
        ...
        aboutPgMain.style.paddingBottom = '80px';
    }

    // if were on the portfolio page
    else if (projectGrid != null) {
...
function switchToHorizontalScreen() {
    ...
    // only modify about page stuff when you're on the about page
    if (portraitContainer != null) {
        ...
        aboutPgMain.style.paddingBottom = '50px';
    }
